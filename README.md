...
L'intero patrimonio informativo è archiviato sotto forma di file di testo in formato standard Markdown, eliminando ogni dipendenza da database proprietari o piattaforme cloud commerciali chiuse. Questa infrastruttura si basa sulla metodologia "Folders over Agents" (nota come Interpretable Context Methodology, ICM), che delega la gestione del ciclo di vita operativo alla struttura stessa delle cartelle sul disco, rinunciando a complessi orchestratori di codice e prevenendo l'Agentic Bloat. L'impostazione "State-of-the-Art 2026" garantisce piena interoperabilità con [Obsidian](https://obsidian.md/) (l'applicazione per la gestione di basi di conoscenza basata su grafi) come front-end umano.

Sul fronte dell'esecuzione, lo stack è 100% open-source e self-hosted. Le comunicazioni vengono intermediate da [LiteLLM](https://litellm.ai/) (il gateway locale per la standardizzazione e l'instradamento delle API verso provider gratuiti o LLM in locale), mentre la sicurezza è garantita da filtri anti-injection come [LLM Guard](https://llm-guard.com/). Le interfacce agentiche, distaccate dal contesto del codice sorgente, operano come una Agent Context Platform servendosi di client desktop gratuiti come [OpenWork](https://github.com/) e [Goose](https://block.github.io/goose/), i quali si interfacciano in sicurezza con i database e i file locali tramite il protocollo [Model Context Protocol](https://modelcontextprotocol.io/). I contenuti pubblici risiedono all'interno della directory `docs/`, mentre la configurazione del sito statico è definita in `mkdocs.yml`.
